...
import { Box, InputAdornment, IconButton, InputLabel, Select, MenuItem, MuiThemeProvider, createMuiTheme, Snackbar, Card } from "@material-ui/core";
        ...
        return (
            <Card style={{ marginTop: '5%', padding: '16px' }}>
                <ContainerPanel>
                    ...
                    <Box minWidth={200} maxWidth={400} marginTop={2} alignSelf='center'>
